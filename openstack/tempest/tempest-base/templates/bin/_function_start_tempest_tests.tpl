...
function start_tempest_tests {
  ...
  export IMAGE_REF_ALT=$(openstack image list | grep {{ default "ubuntu-20.04-amd64-vmware" (index .Values (print .Chart.Name | replace "-" "_")).tempest.image_ref }} | awk {' print $2 '})
  ...
  ls -la /home/rally/
  cd /home/rally/.rally/verification/verifier*/for-deployment* && tar cfvz /tmp/tempest-log.tar.gz ./tempest.log && cd /home/rally/
